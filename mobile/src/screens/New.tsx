...
export function New() {
    ...
    return (
       <VStack flex={1} bgColor="gray.900">
        <Header  title="Criar novo bolão" onShare={null}/>
        ...
        <VStack mt={8} mx={5} alignItems="center">
            ...
            <Input mb={2} placeholder="Qual nome do seu bolão?" onChangeText={setTitle} 
            value={title} />

            <Button 
                title="CRIAR MEU BOLÃO" onPress={handlePoolCreate} isLoading={isLoading}
            />
